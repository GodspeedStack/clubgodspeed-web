...
window.handleCoachLogin = function () {
 ...
 // Secure Access Check
 // In production, this should be server-side validation. // For this prototype, we use a shared team code.
...
function loadTeamRoster(teamId, navItem) {
 ...
 html += `
 <div onclick="viewPlayerReport('${athlete.athleteId}')" class="group"
