...
function createReceiptModalHTML(receipt) {
 ...
 <button onclick="downloadReceiptPDF('${escapeHTML(receipt.id)}')" class="btn-primary" style="flex: 1; padding: 14px; border-radius: 10px; font-size: 15px; font-weight: 600;">
 Download PDF
 </button>
 <button onclick="viewReceiptPDF('${escapeHTML(receipt.id)}')" class="btn-secondary" style="flex: 1; padding: 14px; border-radius: 10px; font-size: 15px; font-weight: 600; background: white; border: 1px solid #e5e7eb; color: #111;">
 Open PDF
 </button>
 </div>
