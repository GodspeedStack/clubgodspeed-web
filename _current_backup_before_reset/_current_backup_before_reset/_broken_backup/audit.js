...
function showResult() {
 ...
 // Prompt Order: 1=D1, 2=Highlight, 3=Gym Rat. // Logic: Gym Rat is better than Highlight Hero (who is repellant). // Let's assume Gym Rat is the "Try hard but fail" (Middle) and Highlight Hero is "Bad attitude" (Low).
 title = "THE GYM RAT";
