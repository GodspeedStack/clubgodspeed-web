...
function renderLifetimeStats() {
    ...
    // Player performance and game log sourced from Supabase (player_game_stats + games tables)
    const playerPerformance = db.playerPerformance || [];
    const gameLog = db.gameLog || [];
